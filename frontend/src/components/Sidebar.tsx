  ...
  return (
    <aside className="w-72 border-r border-slate-200 dark:border-slate-800 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md flex flex-col justify-between p-6 h-screen sticky top-0 z-40">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Enroll Device Biometrics Button */}
        <button 
          onClick={handleEnrollBiometrics}
          disabled={registeringBio}
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-violet-600/10 hover:bg-violet-600/20 border border-violet-500/20 text-violet-500 dark:text-violet-400 font-bold text-xs rounded-xl transition-all cursor-pointer disabled:opacity-50"
        >
          🔑 {registeringBio ? 'Enrolling Key...' : 'Register Device Biometrics'}
        </button>
